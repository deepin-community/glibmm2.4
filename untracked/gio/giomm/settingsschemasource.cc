...
Glib::RefPtr<SettingsSchemaSource> SettingsSchemaSource::create(const std::string& directory, bool trusted, const Glib::RefPtr<SettingsSchemaSource>& parent)
{
  ...
  Glib::RefPtr<SettingsSchemaSource> retvalue = Glib::wrap(g_settings_schema_source_new_from_directory(directory.c_str(), Glib::unwrap(parent), static_cast<int>(trusted), &(gerror)));
  if(gerror)
